...
process_Cms_items(path.join(__dirname, "../cms_items"), "src/cms_items.json");
process_Cms_items(path.join(__dirname, "../cms_folders"), "src/cms_folders.json");
//getPages()